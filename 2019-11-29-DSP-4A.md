...
//componi un onda quadra di frequenza fondamentale 100Hz e 9 armoniche (dispari).
...
```
// Scrivi il codice di programma del seguente diagramma a blocchi. [5/30]
import("stdfaust.lib") ;
